...
import 'package:knocadoor/screens/product_details.dart';
...
class ProductCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    List<Color> _colors = [Colors.green, Colors.limeAccent];
            ...
            children: <Widget>[
              ...
              RichText(
                text: TextSpan(children: [
                  ...
                  TextSpan(
                    text: '\Rs.${product.price / 100} \t',
                    style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold),
                  ),
                  TextSpan(
                    text: product.sale ? '30 % OFF ' : "",
                    style: TextStyle(
                        fontSize: 18,
